...
const tennisStats = [
  { value: '5', title: 'ГРУНТОВЫХ КОРТОВ', desc: 'международного класса' },
  { value: '30', title: 'ЕДИНОМЫШЛЕННИКОВ', desc: 'влюблённых в теннис' },
  { value: '3', title: 'ЧАСА ВИДЕОРАЗБОРА', desc: 'и теории по технике тенниса' },
...
const cultureItems = [
  { title: 'ГАСТРОМАРШРУТ', desc: 'вкусы Ташкента' },
